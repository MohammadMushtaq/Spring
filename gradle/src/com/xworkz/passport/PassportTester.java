...
public class PassportTester {
	...
	public static void main(String[] args) {
		...
		PassportServiceImp passportServiceImp= container.getBean(PassportServiceImp.class);
		passportServiceImp.validateAndSave(pass);
	//PassportDAO passportDAO= container.getBean(PassportDAO.class);
